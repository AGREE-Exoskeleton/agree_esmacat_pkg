...
struct sea_controller_configuration_t
{
    ...
    float friction_comp_vibration_frequency = 0.0;
    float friction_comp_vibration_amplitude = 0.0;
...
struct agree_torque_control_status_t
{
...
struct agree_impedance_control_status_t
{
    ...
    /** Derivative gain for the impedance control loop */
    float impedance_control_D_mNm_rad_sec    = 0.0;
    // initialize all values to 0
};

/** Holds the commanded impedance control parameters */
struct sea_impedance_control_command_t{
    /** Proportional gain for the impedance control loop */
    ...
    sea_impedance_control_command_t()
    {
